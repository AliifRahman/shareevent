	...
	<div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('cover.jpg'); height: 60vh; max-height:460px;">
			<div class="container max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
				<!--Title-->
					...
					<p class="text-xl md:text-2xl text-gray-500">Share Your Beautiful Events With Us!</p>
			</div>
		</div>
		...
		<div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
			...
			<div class="mx-0 sm:mx-6">
					...
					<div class="container mx-auto flex items-center">
						...
						<div class="flex w-1/2 pl-4 text-sm">
							<ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
								...
								<li class="mr-2">
								<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href="#">Register</a>
								</li>
								<li class="mr-2">
								<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href="#">Login</a>
								</li>
								<li class="mr-2">
								<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href="post_vue.html">example</a>
								</li>
							</ul>
						</div>
					...
					<a href="post.html" class="flex flex-wrap no-underline hover:no-underline">
						...
						<div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
							<div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
								...
								<div class="w-full font-bold text-xl text-gray-900 px-6">👋 Welcome to Share Event!</div>
								<p class="text-gray-800 font-serif text-base px-6 mb-5">
									sebenarnya, ini pake tailwind loh. Agak susah pakainya, karena masih baru. Tapi ya lumayan bagus karena udah ada component yang siap copas xdd.
								</p>
							</div>
				...
				<div class="container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center">
					<h2 class="font-bold break-normal text-2xl md:text-4xl">Subscribe to ShareEvent</h2>
			...
			<div class="w-full mx-auto flex flex-wrap items-center">
				<div class="flex w-full md:w-1/2 justify-center md:justify-start text-white font-extrabold">
					<a class="text-gray-900 no-underline hover:text-gray-900 hover:no-underline" href="#">
					    <span class="text-base text-gray-200">ShareEvent</span>
					</a>
				</div>
				<div class="flex w-full pt-2 content-center justify-between md:w-1/2 md:justify-end">
					<ul class="list-reset flex justify-center flex-1 md:flex-none items-center">
					  ...
					  <li>
						<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-3" href="#">Register</a>
					  </li>
					  <li>
						<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-3" href="#">Login</a>
					  </li>
						<li>
						<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-3" href="#">My account</a>
					  </li>
					</ul>
				</div>
			</div>
...
<?php /**PATH D:\sertikom\CRUD-Laravel-Tailwind-CSS-master\resources\views/welcome.blade.php ENDPATH**/ ?>